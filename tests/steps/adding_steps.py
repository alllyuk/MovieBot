...
def add_movie_to_wishlist(users: dict[str, FakeUser], user_service, wishlist_service, user_name: str, movie: str):
...
def add_movies_to_wishlist(users: dict[str, FakeUser], user_service, wishlist_service, user_name: str, datatable):
...
def empty_wishlist(users: dict[str, FakeUser], user_service, user_name: str):
...
def user_sends_message(users: dict[str, FakeUser], user_service, wishlist_service, fake_bot: FakeBot, user_name: str, message: str):
...
def movie_in_wishlist(users: dict[str, FakeUser], wishlist_service, movie: str, user_name: str):
...
def movie_not_in_wishlist(users: dict[str, FakeUser], wishlist_service, movie: str, user_name: str):
